...
contract FlashLoanArbitrage is FlashLoanSimpleReceiverBase {
    ...
    constructor(address _addressProvider,address  _daiAddress, address _usdcAddress, address _dexContractAddress)
    ...
    function executeOperation(
        ...
        dexContract.buyDAI();
        dexContract.depositDAI(1200000000000000000000);
        dexContract.sellDAI();
